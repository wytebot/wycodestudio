...
const blank={name:"",slug:"",description:"",category:"Developer Tools",price:9.99,currency:"USD",status:"draft",version:"1.0.0",demoUrl:"",driveFileId:"",coverUrl:"",features:"",requirements:"",license:"Single-project commercial license"};
...
function App(){
 ...
 async function save(e){
   ...
   if(f.get("status")==="published"&&!String(f.get("driveFileId")||"").trim()){setMsg("A Google Drive file ID is required before publishing a product.");return}
